...
import { INTERNAL_ACCOUNT_ETH_ADDR, INTERNAL_BJJ_ETH_ADDR } from '@hermeznetwork/hermezjs/src/constants'
...
function Transaction ({
  ...
  function showBJJ (type) {
    if (type === 'from') {
      return (transactionTask.data.fromBjj && transactionTask.data.fromBjj !== INTERNAL_BJJ_ETH_ADDR) || (transactionTask.data.fromBJJ && transactionTask.data.fromBJJ !== INTERNAL_BJJ_ETH_ADDR)
    }
    if (type === 'to') {
      return (transactionTask.data.toBjj && transactionTask.data.toBjj !== INTERNAL_BJJ_ETH_ADDR) || (transactionTask.data.toBJJ && transactionTask.data.toBJJ !== INTERNAL_BJJ_ETH_ADDR)
    }
  }
