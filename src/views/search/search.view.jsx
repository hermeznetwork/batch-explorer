...
function Search({ changeRoute, onLoadCoordinator, coordinatorTask, onLoadAccount, accountTask }) {
  ...
  const transactionIdPattern = new RegExp(
    "^0x00[a-fA-F0-9]{64}|^0x01[a-fA-F0-9]{64}|^0x02[a-fA-F0-9]{64}$"
  );
